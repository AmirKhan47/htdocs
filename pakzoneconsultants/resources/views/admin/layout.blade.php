...
<head>
  ...
  <title>Pakzone Consultants | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>PZC</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Pakzone Consultants</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">{{ session('data')[0]->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            <li class="{{ request()->is('admin') ? 'active' : '' }}"><a href="/admin"><i class="fa fa-circle-o"></i> Dashboard </a></li>
            <li class="{{ request()->is('admin/user') ? 'active' : '' }}"><a href="/admin/user"><i class="fa fa-circle-o"></i> Users </a></li>
            <li class="{{ request()->is('admin/slider') ? 'active' : '' }}"><a href="/admin/slider"><i class="fa fa-circle-o"></i> Slider Settings </a></li>
            <li class="{{ request()->is('admin/header') ? 'active' : '' }}"><a href="/admin/header"><i class="fa fa-circle-o"></i> Header Settings </a></li>
            <li class="{{ request()->is('admin/home') ? 'active' : '' }}"><a href="/admin/home"><i class="fa fa-circle-o"></i> Home Page Settings </a></li>
            <li class="{{ request()->is('admin/file') ? 'active' : '' }}"><a href="/admin/file"><i class="fa fa-circle-o"></i> Files </a></li>
            <li class="{{ request()->is('admin/news') ? 'active' : '' }}"><a href="/admin/news"><i class="fa fa-circle-o"></i> News </a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="http://www.redstartechs.com/">Red Star Technologies</a>.</strong> All rights
    reserved.
  </footer>
