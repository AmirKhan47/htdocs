	...
	<section class="whole-wrap">
		<div class="container">
			<div class="section-top-border">
				...
				<div class="row">
					<div class="col-md-3">
						<img src="theme_assets/img/elements/d.jpg" alt="" class="img-fluid">
					</div>
				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f1.jpg" alt="flag">Canada</div>
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f2.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f3.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f4.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f5.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f6.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f7.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
						...
						<div class="table-row">
							...
							<div class="country"> <img src="theme_assets/img/elements/f8.jpg" alt="flag">Canada</div>
							<div class="visit">645032</div>
							<div class="percentage">
								<div class="progress">
			...
			<div class="section-top-border">
				...
				<div class="row gallery-item">
					<div class="col-md-4">
						<a href="theme_assets/img/elements/g1.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g1.jpg);"></div></a>
					</div>
					<div class="col-md-4">
						<a href="theme_assets/img/elements/g2.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g2.jpg);"></div></a>
					</div>
					<div class="col-md-4">
						<a href="theme_assets/img/elements/g3.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g3.jpg);"></div></a>
					</div>
					<div class="col-md-6">
						<a href="theme_assets/img/elements/g4.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g4.jpg);"></div></a>
					</div>
					<div class="col-md-6">
						<a href="theme_assets/img/elements/g5.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g5.jpg);"></div></a>
					</div>
					<div class="col-md-4">
						<a href="theme_assets/img/elements/g6.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g6.jpg);"></div></a>
					</div>
					<div class="col-md-4">
						<a href="theme_assets/img/elements/g7.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g7.jpg);"></div></a>
					</div>
					<div class="col-md-4">
						<a href="theme_assets/img/elements/g8.jpg" class="img-gal"><div class="single-gallery-image" style="background: url(theme_assets/img/elements/g8.jpg);"></div></a>
					</div>
				</div>
			</div>
			<div class="section-top-border">
