<?php
	...
	class Datatable_model extends CI_Model 
	{
		...
		{
			$column_order = array('user_id','full_name','username','email','password','created_date'); //set column field database for datatable orderable
			$column_search = array('user_id','full_name','username','email','password','created_date'); //set column field database for datatable searchable 
