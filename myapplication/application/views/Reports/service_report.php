                                   ...
                                   <div class="row">
                                    <div class="col-md-6">
                                     <div class="form-group">
                                        <label class="col-md-3 col-form-label"><strong>Service From Date</strong></label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                    	<div class="form-group">
                                        <label class="col-md-3 col-form-label"><strong>Service To Date</strong></label>
                                        <div class="col-md-6">
                                        <!-- <input name="cheque_date" id="cheque_date" class="form-control" type="date"> -->
...
$(document).ready(function() {
  ...
  function urlReload(){
    table.ajax.url("<?php echo site_url('Reports/populateService')?>/"+from_date+"/"+to_date).load();
  }
  $('#table tbody').on('dblclick', 'tr', function () {
      //it follows 0-based indexing
      id = $(this).closest('tr').find('td:eq(1)').text();
      window.location = "<?php echo site_url('Invoice/serviceInvoice')?>/"+id;
    } );
  table = $('#table').DataTable({ 
      // Load data for the table's content from an Ajax source
      "ajax": {
          "url": "<?php echo site_url('Reports/populateService')?>/"+from_date+"/"+to_date,
          "type": "POST"
      },
      buttons: [
