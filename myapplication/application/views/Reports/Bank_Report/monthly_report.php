                               ...
                               <div class="portlet-body">
                                ...
                                <!-- <div class="row">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                          <label class="col-md-3 col-form-label"><strong>Total Expense</strong></label>
                                          <div class="col-md-6">
                                            <input readonly style="background-color: rgba(0,0,0,0); border: none;" id="total_expense" class="col-md-3 col-form-label" value="" />
                                            <span class="help-block"></span>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group ">
                                          <label class="col-md-3 col-form-label"><strong>Total Income</strong></label>
                                          <div class="col-md-6">
                                            <input readonly style="background-color: rgba(0,0,0,0); border: none;" id="total_income" class="col-md-3 col-form-label" value="" />
                                              <span class="help-block"></span>
                                          </div>
                                      </div>     
                                    </div>
...
$(document).ready(function() {
  ...
  function urlReload(){
      table.ajax.url("<?php echo site_url('Reports/populateMonthlyReport')?>/"+from_date+"/"+to_date).load();
  }
  ...
  table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('Reports/populateMonthlyReport')?>/"+from_date+"/"+to_date,
          "type": "POST"
      },
      buttons: [
