                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control" name="trans_type" id="trans_type" required> 
                                            ...
                                            <option value="<?php echo $acc->type; ?>" ><?php echo $acc->type; ?></option>
                                            <?php } }?>
                                          </select>  
...
$(document).ready(function() {
  ...
  function urlReload(){
      table.ajax.url("<?php echo site_url('Reports/populateDailyReport')?>/"+from_date+"/"+to_date+"/"+ty_type).load();
  }
  ...
  table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('Reports/populateDailyReport')?>/"+from_date+"/"+to_date+"/"+ty_type,
          "type": "POST"
      },
      buttons: [
