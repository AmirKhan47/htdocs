...
$(document).ready(function() {
  ...
  function urlReload(){
      table.ajax.url("<?php echo site_url('Reports/populateCustomerAccountsReport')?>/"+from_date+"/"+to_date).load();
  }
  ...
  table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('Reports/populateCustomerAccountsReport')?>/"+from_date+"/"+to_date,
          "type": "POST"
      },
