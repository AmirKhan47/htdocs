...
$(document).ready(function() {
  ...
  function urlReload(){
      table.ajax.url("<?php echo site_url('Reports/populateAccountsReport')?>/"+from_date+"/"+to_date+"/"+account).load();
  }
  ...
  table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('Reports/populateAccountsReport')?>/"+from_date+"/"+to_date+"/"+account,
          "type": "POST"
      },
      buttons: [
