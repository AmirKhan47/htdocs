                                   ...
                                   <div class="row">
                                    <div class="col-md-6">
                                     <div class="form-group">
                                        <label class="col-md-3 col-form-label"><strong>Sale From Date</strong></label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                    	<div class="form-group">
                                        <label class="col-md-3 col-form-label"><strong>Sale To Date</strong></label>
                                        <div class="col-md-6">
                                        <!-- <input name="cheque_date" id="cheque_date" class="form-control" type="date"> -->
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group ">
                                        ...
                                        <select class="form-control" name="business_name" id="business_name"> 
                                            ...
                                            <!-- if customers are to be matced using id then use id here and include customer table in the join as well -->
                                            <option value="<?php echo $name->customer_id; ?>" ><?php echo $name->cust_business_name; ?></option>
                                            <?php } }?>
                                          </select>  
                                          <span class="help-block"></span>
                                        </div>
...
$(document).ready(function() {
  ...
  function urlReload(){
    ...
    table.ajax.url("<?php echo site_url('Reports/populateSale')?>/"+from_date+"/"+to_date+"/"+cust.trim()+"/"+type.trim()).load();
    var amount=0;
  ...
  table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('Reports/populateSale')?>/"+from_date+"/"+to_date+"/"+cust+"/"+type,
          "type": "POST"
      },
       buttons: [
