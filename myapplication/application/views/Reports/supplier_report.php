...
$(document).ready(function() {
  ...
  function urlReload(){
    table.ajax.url("<?php echo site_url('Reports/populateSupplier')?>/"+from_date+"/"+to_date+"/"+sup).load();
    var amount=0;
  ...
  table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('Reports/populateSupplier')?>/"+from_date+"/"+to_date+"/"+sup,
          "type": "POST"
      },
      buttons: [
