                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li> <strong>Name</strong>&emsp;&emsp;&emsp; <?php echo $detail->temp_name;?></li>
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li> <strong>Salesman</strong>&emsp;&emsp;<?php echo $detail->user_name;?></li>
                                        <!-- <li> <strong>Customer In Charge</strong><?php echo $detail->user_name;?></li> -->
