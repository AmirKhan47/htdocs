                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li> <strong>Name</strong>&emsp;&nbsp; <?php echo $detail->cust_name;?></li>
                                        ...
                                        <li> <strong>Contact #</strong>&emsp;<?php echo $detail->cust_contact;?></li>
                                ...
                                <div class="col-xs-12">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $total=$total+(int)($items['prd_qty'])*(int)($items['prd_price'])*(int)($difference->d); ?>
                                            <tr>
                                                <td><?php echo $i; ?> </td>
                                                ...
                                                <td ><?php echo (int)($items['prd_qty'])*(int)($items['prd_price']); ?></td>
                                            </tr>
                                            <?php } ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-xs-offset-4 invoice-block">
                                    <ul class="list-unstyled amounts">
                                        ...
                                        <li>
                                            <strong>Grand Total:</strong> <span id="grandTotal"> <?php echo $total; ?></span></li>
                                    </ul>
