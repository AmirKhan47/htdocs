			...
			<div class="m-portlet__body">
				<div class="form-group m-form__group row">
			        ...
			        <div class="table-responsive">
						<table id="all_hostels_datatable" class="table table-sm table-striped- table-bordered table-hover table-checkable dataTable no-footer">
							<thead>
								<tr>
									<!-- <th>#</th> -->
									<th>Hostel Name</th>
					...
					<div class="modal-body">
						<form id="status_change_form">
							<div class="form-group">
								...
								<?php
									$status_id='<span id="modal_status_id"></span>';
									// echo $status_id;
									// var_dump($status_id);
									// if($status_id== "1")
									// {
								...
								<select class="form-control" name="status_id" id="status_id" required="required">
									<?php foreach ($statuses as $key => $value) { ?>
										<option value="<?php echo $value['status_id']; ?>" <?php if($status_id==$value['status_id']) { echo 'selected'; } ?>><?php echo $value['status_name']; ?></option>
									<?php } ?>
								</select>
							</div>
							<div class="modal-footer">
	...
	function hostel_detail(hostel_id='',last_hostel_status_id='')
	{
		...
		.done(function(data)
		{
			...
			var facility_id = [],
  			...
  			{
  				var images=$('<img src="<?php echo Admin_Uploads.'hostel_pictures/'?>'+value.picture_name+'" width="100" height="100" alt="Hostel Pictures">');
