			...
			<div class="m-portlet__body">
				<div class="form-group m-form__group row">
			        ...
			        <div class="table-responsive">
						<table id="approved_hostels_datatable" class="table table-sm table-striped- table-bordered table-hover table-checkable dataTable no-footer">
							<thead>
								<tr>
									<!-- <th>#</th> -->
									<th>Hostel Name</th>
							...
							<div class="form-group">
								...
								<select class="form-control" name="status_id" id="status_id" required="required">
									<?php foreach ($statuses as $key => $value) { ?>
										<option value="<?php echo $value['status_id']; ?>" <?php if(2==$value['status_id']) { echo 'selected'; } ?>><?php echo $value['status_name']; ?></option>
									<?php } ?>
								</select>
							</div>
						</form>
