			...
			<div class="m-portlet__body">
				<div class="form-group m-form__group row">
					<div class="row">
			            ...
			            <div class="col-md-2 cwd form-group"> 
			                <input type="text" class="form-control column_filter" data-column="4" name="rent2" id="id6" placeholder="Status">
			            </div>
			            <!-- <div class="col-md-2 cwd form-group"> 
			        ...
			        <div class="table-responsive">
						<table id="all_customers_datatable" class="table table-sm table-striped- table-bordered table-hover table-checkable dataTable no-footer">
							<thead>
								<tr>
									<!-- <th>#</th> -->
									<th>Username</th>
