...
<body>
        <nav class="navbar bg-info pl-0 ml-0">
                <div class="container pl-2 ml-0">
                    <a class="navbar-brand bg-light p-1" href="#"><img src="<?php echo SURL.'assets/logo/logo1.jpg'; ?>" alt="" height="40px;"></a>
                     <a href="" class="text-light">Register Doctor</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mt-5 mx-auto bg-light p-3">
                <form method="post" id="assistant_add" action="<?php echo SURL.'Admin/add_doctor'; ?>">
                    ...
                    <div class="text-center">
                        ...
                        <input type="submit" class="btn btn-info" id="add_assistant" name="add_doctor" value="ADD" >
                    </div>
