...
class User_model extends CI_Model
{
	...
	{
		$column_order = array('first_name','last_name','company','job_title','category','email','bussiness_phone','home_phone',); //set column field database for datatable orderable
		$column_search = array('first_name','last_name','company','job_title','category','email','bussiness_phone','home_phone',); //set column field database for datatable searchable 
