...
{
    var ltable = $('#file_completion_students_datatable');
    ...
    var leadtable=ltable.DataTable(
    {
        ...
        "ajax": 
        {
            "url": window.location.origin+"/gsis/admin/get_file_completion_students/",
    ...
    {
        $('#file_completion_students_datatable').DataTable().column( i ).search(
            $('#id'+i).val()
        ).draw();
    }
    $(document).ready(function()
