...
$(document).ready(function()
{
    ...
    // {
        $("#applying_for_form").submit(function(event)
        {
            ...
            var url="http://localhost/gsis/recruitment/applying_for_update/";
...
$(document).ready(function()
{
    ...
    {
        event.preventDefault();
        var url="http://localhost/gsis/recruitment/personal_details_update/";
...
$(document).ready(function()
{
    ...
    {
        event.preventDefault();
        var url="http://localhost/gsis/recruitment/children_details_add/";
...
function delete_child(id,event)
{
    ...
    var url="http://localhost/gsis/recruitment/children_details_delete/";
...
function submitupdate(id,event)
{
    ...
    var url="http://localhost/gsis/recruitment/children_details_update/"+id;
...
$(document).ready(function()
{
    ...
    {
        event.preventDefault();
        var url="http://localhost/gsis/recruitment/test_demo_result_update/";
