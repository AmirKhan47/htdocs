...
//    	$.ajax(
//    	{
//    		url:'http://localhost/gsis/file/file_completion/'+student_id + '/' + name,
//        type:'POST',
//        data:data,
//        cache:false,
//        contentType: false,
...
// }
// -------------------- 15 File Uploading --------------------
// var URL='http://localhost/gsis/file/'; //For Localhost
...
$(document).ready(function()
	{
		...
		$('#upload_undertaking').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion/'+student_id, //localhost
		       	...
		       	success:function(data)
		       	{
		       		...
		       		if(data==2)
		           	{
		               window.location.href='http://localhost/gsis/file/index/'+student_id;
		       		...
		       		else
		       		{
			       		...
			       		$("#download_undertaking").html('<a href="http://localhost/gsis/file/download/'+obj.undertaking+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_copy_of_paid_fee_challan').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion1/'+student_id,
		       	...
		       	success:function(data)
		       	{
		       		...
		       		else
		       		{
			       		...
			       		$("#download_copy_of_paid_fee_challan").html('<a href="http://localhost/gsis/file/download/'+obj.copy_of_paid_fee_challan+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_copy_of_paid_registration_slip').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion2/'+student_id,
		       	...
		       	{	
		       		...
		       		else
		       		{
			       		...
			       		$("#download_copy_of_paid_registration_slip").html('<a href="http://localhost/gsis/file/download/'+obj.copy_of_paid_registration_slip+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_photographs').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion3/'+student_id,
		       	...
		       	{	
		      		...
		      		if(data==2)
		       		...
		       		else
		       		{
						...
						$("#download_photographs").html('<a href="http://localhost/gsis/file/download/'+obj.photographs+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_copy_of_form_b').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion4/'+student_id,
		       	...
		       	{	
		       		...
		       		else
		       		{
						...
						$("#download_copy_of_form_b").html('<a href="http://localhost/gsis/file/download/'+obj.copy_of_form_b+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_copy_of_guardian_cnic').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion5/'+student_id,
		       	...
		       	{	
		       		...
		       		else
		       		{
						...
						$("#download_copy_of_guardian_cnic").html('<a href="http://localhost/gsis/file/download/'+obj.copy_of_guardian_cnic+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_school_leaving_certificate').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion6/'+student_id,
		       	...
		       	{	
		       		...
		       		else
		       		{
						...
						$("#download_school_leaving_certificate").html('<a href="http://localhost/gsis/file/download/'+obj.school_leaving_certificate+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_record_of_results').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion7/'+student_id,
		       	...
		       	{	
		       		...
		       		else
		       		{
						...
						$("#download_record_of_results").html('<a href="http://localhost/gsis/file/download/'+obj.record_of_results+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_merit_certificates').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion8/'+student_id,
		       	...
		       	{	
		       		...
		       		else
		       		{
						...
						$("#download_merit_certificates").html('<a href="http://localhost/gsis/file/download/'+obj.merit_certificates+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_gap_certificate').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion9/'+student_id,
		       	...
		       	success:function(data)
		       	{
		       		...
		       		else
		       		{
						...
						$("#download_gap_certificate").html('<a href="http://localhost/gsis/file/download/'+obj.gap_certificate+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_character_certificate').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion10/'+student_id,
		       	...
		       	success:function(data)
		       	{
		       		...
		       		else
		       		{
						...
						$("#download_character_certificate").html('<a href="http://localhost/gsis/file/download/'+obj.character_certificate+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_migration_certificate').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion11/'+student_id,
		       	...
		       	success:function(data)
		       	{
		       		...
		       		else
		       		{
						...
						$("#download_migration_certificate").html('<a href="http://localhost/gsis/file/download/'+obj.migration_certificate+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_registration_card').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion12/'+student_id,
		       	...
		       	success:function(data)
		       	{
		       		...
		       		else
		       		{
						...
						$("#download_registration_card").html('<a href="http://localhost/gsis/file/download/'+obj.registration_card+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_equivalence_certificate').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion13/'+student_id,
		       	...
		       	success:function(data)
		       	{
		       		...
		       		else
		       		{
						...
						$("#download_equivalence_certificate").html('<a href="http://localhost/gsis/file/download/'+obj.equivalence_certificate+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
	 	...
	 	$('#upload_cancelation_of_result').click(function(e)
		{
			...
			data.append('key', 'value');
		   	...
		   	$.ajax(
		   	{
	       		url:'http://localhost/gsis/file/file_completion14/'+student_id,
		       	...
		       	success:function(data)
		       	{
		       		...
		       		else
		       		{
						...
						$("#download_cancelation_of_result").html('<a href="http://localhost/gsis/file/download/'+obj.cancelation_of_result+'"><button type="button" class="btn btn-info chk2" id=""><i class="fa fa-upload"></i></button></a>');
...
// 	   	$.ajax(
// 	   	{
// 	       url:'http://localhost/gsis/file/file_completion/'+student_id,
...
// 	       		else
// 	       		{
// 	       			 window.location.href='http://localhost/gsis/file/file_completion/'+student_id;
// 	       	// 		$('#msg').html(data).fadeIn('slow');
// 			     	// $('#msg').html("data insert successfully").fadeIn('slow'); //also show a success message 
// 			     	// $('#msg').delay(5000).fadeOut('slow');
// 	        //        	$("#form")[0].reset();
