<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo SURL;?>challan/index/<?php echo $student_id ;?>">Challan Form</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>Challan From Update</span>
        </li>
    </ul>
</div>
<div class="portlet-title">
    <div class="h3 text-uppercase"><b>Update Challan Form</b>
    </div>
</div>
<div class="portlet-body">
    <form action="<?php echo base_url(); ?>challan/edit1" id="form_sample_18" class="" method="post" enctype="multipart/form-data">
        <input type="hidden" name="student_id" value="<?php echo $student_id; ?>">
        <input type="hidden" name="challan_id" value="<?php echo $challan['id']; ?>">
        <div class="row">
            <div class="col-md-6">
    ...
    <br>
    <form action="<?php echo base_url(); ?>challan/update" id="form_sample_16" class="form-horizontal" method="post" enctype="multipart/form-data">
        <input type="hidden" name="student_id" value="<?php echo $student_id; ?>">
        <input type="hidden" name="challan_id" value="<?php echo $challan['id']; ?>">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <i class="fa"></i>
                                            <input type="text" pattern="[-+]?[0-9]*[.,]?[0-9]+" max='100' data-rule-minlength="1" data-rule-maxlength="11" id="admission_fee_discount" name="admission_fee_discount" class="form-control" placeholder="%" value="<?php echo $student_fees_discounts['admission_fee_discount']; ?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" data-rule-required="true" pattern="[-+]?[0-9]*[.,]?[0-9]+" data-rule-minlength="1" data-rule-maxlength="11"  id="admission_fee_total" name="admission_fee_total" class="form-control" placeholder="Total" value="<?php echo $challan['challan_admission_fee']; ?>">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <i class="fa"></i>
                                            <input type="text" pattern="[-+]?[0-9]*[.,]?[0-9]+" max='100' data-rule-minlength="1" data-rule-maxlength="11"  id="security" name="security_discount" class="form-control" placeholder="%" value="<?php echo $student_fees_discounts['security_discount']; ?>">
                                            <span class="input-group-addon">
                                                <i class="fa fa-percent font-red">%</i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" data-rule-required="true" pattern="[-+]?[0-9]*[.,]?[0-9]+" data-rule-minlength="1" data-rule-maxlength="11"  id="security" name="security_total" class="form-control" placeholder="Total" value="<?php echo $challan['challan_security_fee']; ?>">
                                                <span class="help-block">Final Amount</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                                <i class="fa"></i>
                                                <input type="text" pattern="[-+]?[0-9]*[.,]?[0-9]+" max='100' data-rule-minlength="1" data-rule-maxlength="11"  id="tution_fee_discount" name="tution_fee_discount" class="form-control" placeholder="%" value="<?php echo $student_fees_discounts['tution_fee_discount']; ?>">
                                                <span class="input-group-addon">
                                                <i class="fa fa-percent font-red">%</i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" data-rule-required="true" pattern="[-+]?[0-9]*[.,]?[0-9]+" data-rule-minlength="1" data-rule-maxlength="11"  id="tution_fee_total" name="tution_fee_total" class="form-control" placeholder="Total" value="<?php echo $challan['challan_monthly_fee']; ?>">
                                                <span class="help-block">Final Amount</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                                <i class="fa"></i>
                                                <input type="text" pattern="[-+]?[0-9]*[.,]?[0-9]+" max='100' data-rule-minlength="1" data-rule-maxlength="11"  id="stationary_fund_discount" name="stationary_fund_discount" class="form-control" placeholder="%" value="<?php echo $student_fees_discounts['stationary_fund_discount']; ?>">
                                                <span class="input-group-addon">
                                                <i class="fa fa-percent font-red">%</i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" data-rule-required="true" pattern="[-+]?[0-9]*[.,]?[0-9]+" data-rule-minlength="1" data-rule-maxlength="11"  id="stationary_fund_total" name="stationary_fund_total" class="form-control" placeholder="Total" value="<?php echo $challan['challan_annual_stationary_fee']; ?>">
                                                <span class="help-block">Final Amount</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <input type="text" pattern="[-+]?[0-9]*[.,]?[0-9]+" max='100' data-rule-minlength="1" data-rule-maxlength="11"  id="annual_fund_discount" name="annual_fund_discount" class="form-control" placeholder="%" value="<?php echo $student_fees_discounts['annual_fund_discount']; ?>">
                                            <span class="input-group-addon">
                                                <i class="fa fa-percent font-red">%</i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" data-rule-required="true" pattern="[-+]?[0-9]*[.,]?[0-9]+" data-rule-minlength="1" data-rule-maxlength="11"  id="annual_fund_total" name="annual_fund_total" class="form-control" placeholder="Total" value="<?php echo $challan['challan_annual_fee']; ?>">
                                                <span class="help-block">Final Amount</span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            <span class="input-icon right">
                                                ...
                                                <select class="_58mq" name="challan_due_day" data-rule-required="true">
                                                    <option value="<?php echo $challan_due_day; ?>"><?php echo $challan_due_day; ?></option>
                                                    <?php 
                                                        for ($i=1; $i <= 31; $i++)
                                                        { 
                                            ...
                                            <span class="input-icon right">
                                                ...
                                                <select class="_58mq" name="challan_due_month" data-rule-required="true">
                                                    <option value="<?php echo $challan_due_month; ?>"><?php echo $challan_due_month; ?></option>
                                            ...
                                            <span class="input-icon right">
                                                ...
                                                <select class="_58mq" name="challan_due_year" data-rule-required="true">
                                                    <option value="<?php echo $challan_due_year; ?>"><?php echo $challan_due_year; ?></option>
                                                    <?php 
                                        ...
                                        <div class="input-group">
                                            <span class="input-icon right">
                                                ...
                                                <select class="_58mq" name="challan_fee_month" data-rule-required="true">
                                                    <option value="<?php echo $challan_fee_month; ?>"><?php echo $challan_fee_month; ?></option>
                                                    <option value="1">Jan</option>
                                                    <option value="2">Feb</option>
                                                    <option value="3">Mar</option>
                                                    <option value="4">Apr</option>
                                            ...
                                            <span class="input-icon right">
                                                ...
                                                <select class="_58mq" name="challan_fee_year" data-rule-required="true">
                                                    <option value="<?php echo $challan_fee_year; ?>"><?php echo $challan_fee_year; ?></option>
                                                    <?php 
                                                        $year = date("Y"); // get the year part of the current date
                                                        $minYear = $year + 50;
                                                        for ($i=$year; $i <= $minYear; $i++) { 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" id="lab_ch" pattern="^[0-9]*$" name="lab_ch" data-rule-minlength="1" data-rule-maxlength="11" class="form-control" placeholder="" value="<?php echo $challan['challan_monthly_lab_fee']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" pattern="^[0-9]*$" maxlength="11" id="exam_charges" name="exam_charges" data-validation="number" class="form-control" placeholder="" value="<?php echo $challan['challan_exam_fee']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" pattern="^[0-9]*$" data-rule-maxlength="11"  id="registration_charges" name="registration_charges" class="form-control" placeholder="" value="<?php echo $challan['challan_registration_fee']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" pattern="^[0-9]*$" data-rule-maxlength="11"  id="deferred" name="deferred" class="form-control" placeholder="" value="<?php echo $challan['challan_deferred']; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" pattern="^[0-9]*$" data-rule-maxlength="11"  id="house_shirt" name="house_shirt" class="form-control" placeholder="" value="<?php echo $challan['challan_house_shirt_fee']; ?>">
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" pattern="^[0-9]*$" data-rule-maxlength="11"  id="received" name="received" class="form-control" placeholder="" value="<?php echo $challan['challan_less_received']; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" pattern="^[0-9]*$" id="monthly_security" name="monthly_security" data-rule-minlength="1" data-rule-maxlength="11" value="<?php echo $challan['challan_monthly_security_fee']; ?>" class="form-control" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" pattern="^[0-9]*$" name="comp_ch" class="form-control" data-rule-minlength="1" data-rule-maxlength="11" id="comp_ch" value="<?php echo $challan['challan_monthly_computer_fee']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <textarea type="text" data-rule-maxlength="100" id="remarks" name="remarks" class="form-control" placeholder="" value=""><?php echo $challan['challan_remarks']; ?></textarea>
                                            </div>
                                            <div class="help-block">
                                            </div>
                                        </div>
