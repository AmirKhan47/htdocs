...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-green-seagreen">
            ...
            <span class="caption-subject bold uppercase"> Registered Students </span>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <table class="table-sm table-striped table-bordered table-hover table-header-fixed dataTable no-footer" id="registered_students">
                <thead>
                    <tr>
                        <th> Reg. No. </th>
                        <th> Roll No. </th>
