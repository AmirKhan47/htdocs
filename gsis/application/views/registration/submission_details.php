		...
		<div class="portlet light bordered ">
		    ...
		    <div class="portlet-body form">
		                <!-- BEGIN FORM-->
		        <form action="<?php echo SURL.'admin/submission_details_submit/'.$student_id;?>" id="form_sample_16" class="form-horizontal" method="post" enctype="multipart/form-data">
		                                        ...
		                                        <div class="col-md-9">
		                                            <div class="input-group">
		                                                ...
		                                                <div class="input-icon right">
		                                                    <i class="fa"></i>
		                                                    	<select class="form-control" data-rule-required="true" name="bank_name">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-9">
		                                            <div class="input-group">
		                                                ...
		                                                <div class="input-icon right">
		                                                    <i class="fa"></i>
		                                                    <input type="date" data-rule-required="true"  id="" name="date_of_payment" class="form-control" placeholder="" value="">
		                                                </div>
		                                            </div>
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-md-9">
		                                            <div class="input-group">
		                                                ...
		                                                <div class="input-icon right">
		                                                    <i class="fa"></i>
		                                                    <input type="text" data-rule-required="true" id="" maxlength="10" minlength="1" name="amount" class="form-control" placeholder="" value="">
		                                                </div>
		                                            </div>
		                                        </div>
		                                    </div>
