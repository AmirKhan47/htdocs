<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Assign Class To Subject</span>
        </li>
    </ul>
</div>
<h3 class="page-title">Assign Class To Subject</h3>
<div class="portlet light bordered ">
    <div class="portlet-title">
        <div class="caption font-green-seagreen">
            <i class="fa fa-user font-green-seagreen"></i>
            <span class="caption-subject bold uppercase">Assign Class To Subject</span>
        </div>  
        <div class="actions">
        </div>
    </div>
    <div class="portlet-body form">
        ...
        ?>
        <form action="<?php echo SURL.'subject/edit_class_subject/'.$class_subject['class_subject_id'];?>" id="" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
