...
<div class="portlet light bordered ">
    <div class="portlet-title">
        <div class="caption font-green-seagreen">
            ...
            <span class="caption-subject bold uppercase">Edit Branch</span>
        </div>  
        <div class="actions">
        </div>
    </div>
    <div class="portlet-body form">
        ...
        ?>
        <form action="<?php echo SURL.'branch/edit_branch/'.$branch['id'];?>" id="" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" id="branch_name" name="branch_name" onblur="branch_name_check()" value="<?php echo $branch['branch_name'];?>" data-validation="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" data-rule-required="true" name="contact_cell" placeholder="" value="<?php echo $contact['contact_cell'];?>" data-validation="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" data-rule-required="true" name="contact_email" placeholder="" value="<?php echo $contact['contact_email'];?>" data-validation="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" data-rule-required="true" name="address_local" placeholder="" value="<?php echo $address['address_local'];?>" data-validation="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
