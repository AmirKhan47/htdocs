...
<h3 class="page-title">Assign Class To Branch</h3>
<div class="portlet light bordered ">
    <div class="portlet-title">
        <div class="caption font-green-seagreen">
            <i class="fa fa-user font-green-seagreen"></i>
            <span class="caption-subject bold uppercase">Assign Class To Branch</span>
        </div>  
        <div class="actions">
        </div>
    </div>
    <div class="portlet-body form">
        ...
        ?>
        <form action="<?php echo SURL.'classes/assign_class_branch/';?>" id="" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
