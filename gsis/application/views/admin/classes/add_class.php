...
<div class="portlet light bordered ">
    ...
    <div class="portlet-body form">
        ...
        ?>
        <form action="<?php echo SURL.'classes/add_class/';?>" id="" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input type="text" class="form-control" data-rule-required="true" id="class_name" name="class_name" oninput="class_name_check()" value="<?php echo set_value('class_name'); ?>" placeholder="" data-validation="required">
