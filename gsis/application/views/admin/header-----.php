                            ...
                            <ul class="sub-menu">
                                ...
                                <!-- <li class="nav-item <?php if($active=='file_completion_students'){?> start active open <?php }?>">
                                    <a href="<?php echo base_url();?>admin/file_completion_students" class="nav-link ">
                                        <i class=""></i>
                                        <span class="title">File Completion Students</span>
                                        <?php
                                            if($this->session->userdata('role')==1)
                                            {
                                                $data['file_completion']=count($this->common->select_array_records('registration',array('registration_status'=>'file pending')));
                                            }
                                            else
                                            {
                                               $data['file_completion']=count($this->common->select_array_records('registration',array('registration_status'=>'file pending','branch_id'=>$this->session->userdata('branch_id'))));
                                            }
                                        ?>
