...
<div class="portlet light bordered ">
    <div class="portlet-title">
        <div class="caption font-green-seagreen">
            ...
            <span class="caption-subject bold uppercase">Add Level</span>
        </div>  
        <div class="actions">
        </div>
    </div>
    <div class="portlet-body form">
        ...
        ?>
        <form action="<?php echo SURL.'level/add_level/';?>" id="" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i> 
                                                    <input type="text" class="form-control" id="level_name" name="level_name" onchange="level_name_check()"  value="<?php echo set_value('level_name'); ?>" data-validation="required">
