...
<div class="portlet light bordered ">
    ...
    <div class="portlet-body form">
        ...
        ?>
        <form action="<?php echo SURL.'designation/add_designation/';?>" id="" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    <i class="fa"></i> 
                                                    <input type="text" class="form-control" data-rule-required="true" id="designation_name" name="designation_name" onchange="designation_name_check()"  value="<?php echo set_value('designation_name'); ?>" data-validation="required">
