        ...
        <script src="<?php echo Assets;?>global/plugins/ladda/spin.min.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>global/plugins/ladda/ladda.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo Assets;?>pages/scripts/ui-buttons-spinners.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo Assets;?>myscript/all_students.js" type="text/javascript"></script>
        ...
        <script src="<?php echo Assets;?>/myscript/employee_email_history_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/departments_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/designations_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/department_designations_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/branches_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/classes_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/branches_classes_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/subjects_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/classes_subjects_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>/myscript/levels_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>myscript/test_applicants_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>myscript/file_completion_applicants_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>myscript/registered_applicants_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>myscript/all_applicants_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>myscript/fee_structure_datatable.js" type="text/javascript"></script>
        <script src="<?php echo Assets;?>myscript/file_completion_students_datatable.js" type="text/javascript"></script>
