            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <!-- <li class="heading">
                            <h3 class="uppercase">Assign Task</h3>
                        </li> -->
                       <!--  <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="<?php //echo base_url(). 'index.php/School/admin_portal'?>" class="nav-link ">
                                        <span class="title">Admin Assinged</span>
                                    </a>
                                </li> -->
                                <!-- <li class="nav-item  ">
                       ...
                       <!--  <li>
                            <a href="<?php echo base_url();?>admin/branch_update" class="nav-link ">
                                <i class="fa fa-edit"></i>
                                <span class="title">Branch Update</span>
                            </a> 
                        </li> -->
                        <!-- <li>
                            <a href="<?php echo base_url();?>" class="nav-link ">
                            ...
                            <!-- <ul class="sub-menu"> -->
                                <!-- <li class="nav-item  ">
                                    <a href="components_date_time_pickers.html" class="nav-link ">
                                        <span class="title">List of Registration</span>
                                    </a>
                                </li> -->
                               <!--  <li class="nav-item  ">
