...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        <form action="<?php echo SURL."user/update/".$user['id']."/".$role;?>" id="registration-form" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control"  id="branch_id" name="branch_id" data-validation="required">
                                            <option value="jlkjlk">kjlj</option>
                                            <?php
                                               if (count($branches)>0) 
                                                {
