...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo SURL.'login/change_password'?>">Change Password</a>
...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        <form action="<?php echo SURL."login/change_password/"?>" id="registration-form" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
