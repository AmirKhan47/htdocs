...
<div class="portlet light bordered ">
    ...
    <div class="portlet-body form">
        ...
        ?>
        <form action="<?php echo SURL.'department/add_department/';?>" id="" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-icon right">
                                                    ...
                                                    <input type="text" class="form-control" data-rule-required="true" id="department_name" name="department_name" onchange="department_name_check()"  value="<?php echo set_value('department_name'); ?>" data-validation="required">
