...
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Applicants List </h3>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-green-seagreen">
            <i class="fa fa-user font-green-seagreen"></i>
            <span class="caption-subject bold uppercase"> Applicants List </span>
        </div> 
        <!-- <div class="actions"> 
    ...
    <div class="portlet-body form">
        ...
        ?>
		<table id="applicants_datatable" class="table table-striped table-bordered table-hover table-header-fixed">
			<thead>
				<tr>
