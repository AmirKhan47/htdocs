...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Manage Test Applicants</span>         
        </li> 
    </ul>
</div>
<!-- END PAGE BAR -->
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Manage Test Applicants List </h3>
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-green-seagreen">
            <i class="fa fa-user font-green-seagreen"></i>
            <span class="caption-subject bold uppercase"> Manage Test Applicants List </span>
        </div> 
        <!-- <div class="actions"> 
    ...
    <div class="portlet-body form">
        ...
        ?>
		<table id="test_applicants_datatable" class="table table-striped table-bordered table-hover table-header-fixed">
			<thead>
				<tr>
