...
class Class_model extends CI_Model
{
	...
	public function get_classes($id=0)
	{
		$column_order = array('class_code','class_name','created_at'); //set column field database for datatable orderable
		$column_search = array('class_code','class_name','created_at'); //set column field database for datatable searchable 
