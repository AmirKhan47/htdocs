...
class Department_model extends CI_Model
{
	...
	public function get_departments($id=0)
	{
		$column_order = array('department_name','created_at'); //set column field database for datatable orderable
		$column_search = array('department_name','created_at'); //set column field database for datatable searchable 
		$order = array('department_id' => 'desc'); // default order 
		$this->db->select('*');
