...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
	...
	<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
														<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
															...
															<li class="m-menu__item  m-menu__item--submenu <?php if($active=='add_product_type' OR $active=='add_product_category' OR $active=='add_product' OR $active=='manage_products') { ?> m-menu__item--open m-menu__item--expanded <?php } ?> " aria-haspopup="true"  m-menu-submenu-toggle="hover">
																...
																<div class="m-menu__submenu ">
																	...
																	<ul class="m-menu__subnav">
																		...
																		<li class="m-menu__item <?php if($active=='add_product_type') { ?> m-menu__item--active <?php } ?> " aria-haspopup="true" >
																			<a  href="<?php echo AURL; ?>products/add_product_type" class="m-menu__link ">
																		...
																		<li class="m-menu__item <?php if($active=='add_product_category') { ?> m-menu__item--active <?php } ?> " aria-haspopup="true" >
																			<a  href="<?php echo AURL; ?>products/add_product_category" class="m-menu__link ">
																				<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																					<span></span>
																				</i>
																				<span class="m-menu__link-text">
																		...
																		<li class="m-menu__item <?php if($active=='add_product') { ?> m-menu__item--active <?php } ?> " aria-haspopup="true" >
																			<a  href="<?php echo AURL; ?>products/add_product" class="m-menu__link ">
																				<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																					<span></span>
																				</i>
																				<span class="m-menu__link-text">
																		...
																		<li class="m-menu__item <?php if($active=='manage_products') { ?> m-menu__item--active <?php } ?> " aria-haspopup="true" >
																			<a  href="<?php echo AURL; ?>products/" class="m-menu__link ">
																				<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																					<span></span>
																				</i>
																				<span class="m-menu__link-text">
															...
															<li class="m-menu__item  m-menu__item--submenu <?php if($active=='home' OR $active=='about' OR $active=='delivery' OR $active=='news' OR $active=='contact') { ?> m-menu__item--open m-menu__item--expanded <?php } ?> " aria-haspopup="true"  m-menu-submenu-toggle="hover">
																<a  href="javascript:;" class="m-menu__link m-menu__toggle">
																	<i class="m-menu__link-icon flaticon-layers"></i>
																	<span class="m-menu__link-text">
																...
																<div class="m-menu__submenu ">
																	...
																	<ul class="m-menu__subnav">
																		...
																		<li class="m-menu__item <?php if($active=='home') { ?> m-menu__item--active <?php } ?> " aria-haspopup="true" >
																			<a  href="<?php echo AURL; ?>home/" class="m-menu__link ">
																				<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																					<span></span>
																				</i>
																				<span class="m-menu__link-text">
