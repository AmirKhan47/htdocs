        ...
        <script src="<?php echo Oppeinscript;?>bdm-datable.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>ro-datable.js" type="text/javascript"></script>
        
        <script src="<?php echo Assets;?>pages/scripts/registration-validation.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>newlead-datatable.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>ro-select2.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>alllead-datatable.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>activity-select2-datatable.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>allotment-datatable.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>review-datatable.js" type="text/javascript"></script>
        <script src="<?php echo Oppeinscript;?>resubmitted-datatable.js" type="text/javascript"></script>
