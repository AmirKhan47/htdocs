...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo AURL.'lead/registration_form'?>">Registration Form</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control"  id="designation" name="designation" data-validation="required">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control"  id="title" name="title"  data-validation="required">
                                            <option value="">Select</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="name" name="name" class="form-control" value="<?php echo set_value('name'); ?>" data-validation="required">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="phone" name="phone" class="form-control" value="<?php echo set_value('phone'); ?>" data-validation="required">
                                        <?php echo form_error('name'); ?>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" name="cu_image" id="cu_image" class="form-control" multiple="multiple" data-validation="required"  data-validation-allowing="jpg, png,mp4"  data-validation-max-size="2M" 
                                        >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control"  id="category" name="category" data-validation="required">
                                            <option value="">Select</option>
