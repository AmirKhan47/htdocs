...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo AURL.'leads/full_detail/'.$leads['id'];?>">leads Detail</a>
                ...
                <div class="portlet light bg-inverse">
                    ...
                    <div class="portlet-body">
                        <ul class="list-group">
                              ...
                              <li class="list-group-item">RO : <strong>
                                <?=$leads['ro'];?></strong><input type="hidden" name="ro_name" id="ro_name" value="<?=$leads['ro'];?>" /><input type="hidden" name="visit_val" id="visit_val" value="<?=$visit;?>" /></li>
...
<script>
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data==1){
               ...
               window.location.href=base_url+ 'lead/detail/'+lead_id; 
            }
  ...
  function changestatus(){
    ...
    if(status2=='Visit'){
        ...
        var visit_val=$('#visit_val').val();
        if(ro_name !='' && visit_val !=''){
            $('#visit-list').addClass('active');
            $('#portlet_tab1').addClass('active');
