                        ...
                        <div class="portlet-body">
                            ...
                            ?> 
                                    <tr>
                                        ...
                                        <td><a href="<?php echo Upload.'customer/'.$value['image'];?>" class="btn btn-success" download="<?php echo str_replace(' ','_', $leads['name']).'_'.$value['image'];?>""><i class="fa fa-download"></i></a></td>
