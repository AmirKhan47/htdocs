...
<div class="portlet light bordered">
    ...
    <div class="portlet-body form">
        <form action="<?php echo AURL."User/registration/"?>" id="registration-form" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="form-body">
...
<script>
  ...
  function usernamechecker(){
    ...
    if(uname !=''){
        $.ajax({
            url:'<?php echo AURL.'User/usernamechecker'?>',
            type:'POST',
            data:{username:uname},
  ...
  function emailchecker(){
    ...
    if(email !=''){
        $.ajax({
            url:'<?php echo AURL.'User/emailchecker'?>',
            type:'POST',
            data:{email:email},
            success:function(data){
                if(data==1){
