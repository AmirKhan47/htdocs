...
class User_model extends CI_Model {
	...
	public function get_bdm($id=0){
     $column_order = array('id','Name','email','username','created_date'); //set column field database for datatable orderable
        $column_search = array('id','Name','email','username','created_date'); //set column field database for datatable searchable 
